    ...
    <div className="bg-white rounded-lg border border-gray-200">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="relative mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFilterChange('categorySearch', e.target.value)
                  }
                  ...
                  filteredCategories.map((category) => (
                    ...
                    >
                      ...
                      <span className="ml-2 text-sm text-gray-700">
                        {category.fullPath}
                        {category.isLeaf && (
                          <span className="text-indigo-600 ml-1">(leaf)</span>
                        )}
                      </span>
                    </label>
                  ))
              ...
              {filters.categorySearch && (
                <p className="text-xs text-gray-500 mt-2">
                  Showing {filteredCategories.length} of {flatCategories.length}{' '}
                  categories
                </p>
              )}
            ...
            {filters.categories.length > 0 && (
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {Object.entries(filters.linkTypes).map(
                    ([type, isSelected]) => (
                      <button
                        key={type}
                        onClick={() =>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Direct: linked directly to selected categories | Inherited:
                  linked to ancestor categories | Global: applies to all
                  categories
                </p>
              </div>
            )}
              ...
              <div>
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      handleFilterChange('showNotApplicable', e.target.checked)
                    }
                    className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                  />
                ...
                <p className="text-xs text-gray-500 mt-1 ml-6">
                  Use this to find attributes that can be linked to the selected
                  categories
                </p>
              </div>
            )}
      ...
      <div className="overflow-x-auto">
        <div className="min-w-[1200px]">
          {' '}
          {/* Force minimum width for wider table */}
